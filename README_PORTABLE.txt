...
RECOMANDĂRI
Motorul curent combină profilul tău de ratinguri, retrieval ALS/content, contextul calendaristic și semnale locale de vizionare. Din 4.6, raportul ALS/conținut este ales local prin backtest pe istoricul tău și rămâne 70/30 dacă niciun challenger nu dovedește un câștig stabil. Din 4.7, feedbackul contextual nu mai repornește backtestul, recalibrarea așteaptă un lot relevant de ratinguri, iar formula activă este verificată pe alegeri, vizionări și ratinguri reale cu rollback conservator. Starea este vizibilă direct în Recomandări și în Taste Hub. Din 3.3, fiecare card vizibil are o expunere imuabilă proprie, iar alegerea, skip-ul, Stremio, confirmarea playback-ului și „L-am văzut” sunt evenimente separate legate de acea expunere exactă.
